    ...
    return (
        ...
        >
            <div className="space-y-8">
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Información del Responsable</h2>
                    <p className="mt-4">
                ...
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Objeto y Uso</h2>
                    <p className="mt-4">
                ...
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Transformación Digital</h2>
                    <p className="mt-4">
                ...
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Propiedad Intelectual</h2>
                    <p className="mt-4">
