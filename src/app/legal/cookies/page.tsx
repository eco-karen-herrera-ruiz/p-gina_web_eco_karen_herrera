    ...
    return (
        ...
        >
            <div className="space-y-8">
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">¿Qué son las Cookies?</h2>
                    <p className="mt-4">
                ...
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Tipos de Cookies Utilizadas</h2>
                    <p className="mt-4">
                ...
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Gestión y Desactivación</h2>
                    <p className="mt-4">
                ...
                <section>
                    <h2 className="text-2xl font-black text-brand-navy border-b-2 border-brand-gold pb-2 uppercase tracking-widest">Consentimiento LOPDP</h2>
                    <p className="mt-4">
