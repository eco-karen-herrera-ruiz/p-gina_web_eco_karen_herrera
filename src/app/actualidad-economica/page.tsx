    ...
    return (
        <RootLayout>
            <div className="bg-background min-h-screen">
                ...
                <section className="relative py-24 bg-gradient-to-br from-brand-navy to-brand-navy-light/80 overflow-hidden">
                    <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-gold rounded-full blur-[150px] translate-x-1/2 -translate-y-1/2" />
                    </div>
                    ...
                    <div className="container mx-auto px-4 md:px-8 relative z-10">
                        <div className="max-w-3xl space-y-6">
                            ...
                            <h1 className="text-5xl md:text-7xl font-heading font-black text-white tracking-tighter italic leading-tight">
                                Actualidad <br />
                                <span className="text-brand-gold">Económica</span>
                            </h1>
                            <p className="text-xl text-white/80 leading-relaxed font-medium max-w-2xl border-l-4 border-brand-gold pl-8">
                    ...
                    <div className="container mx-auto px-4 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                            ...
                            <div className="lg:col-span-8 space-y-12">
                                <div className="bg-white p-6 md:p-10 rounded-[3.5rem] shadow-2xl border-2 border-brand-gold/10">
                                    <div className="flex items-center justify-between mb-8">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h2 className="text-2xl font-heading font-black text-brand-navy italic">Video de Análisis Semanal</h2>
                                                <div className="flex items-center gap-4 text-xs font-bold text-brand-navy/40 uppercase tracking-widest mt-1">
                                    ...
                                    <div className="mt-10 space-y-6">
                                        ...
                                        <div className="p-8 bg-brand-navy-light/20 rounded-3xl border border-brand-gold/20 italic text-brand-navy/80">
                            ...
                            <div className="lg:col-span-4 space-y-8">
                                <div className="p-8 bg-brand-navy rounded-[2.5rem] text-white space-y-6">
                                    <h3 className="text-xs font-black uppercase tracking-[0.3em] text-brand-gold">Temas de Hoy</h3>
                                ...
                                <div className="p-8 border-2 border-dashed border-brand-gold/30 rounded-[2.5rem] flex flex-col items-center text-center space-y-4">
